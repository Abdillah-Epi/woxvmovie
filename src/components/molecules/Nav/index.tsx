...
const Nav: React.FC<NavProps> = ({
    ...
    const [isSigninClicked, resetSigin] = useRecoilState(isClickedAtomFamily("S'identifier"));
    ...
    return (
        <div className='flex w-full items-center justify-between'>
            ...
            {!hideRightSide && (
                ...
                >
                    {!user
                        ? (size === "xl" || size === "lg") && <Button text={"S'identifier"} styles={"rounded-lg"} />
                        : (size === "xl" || size === "lg") && (
                              <div className='flex space-x-5'>
                                  <Regular text={"Déconnexion"} styles='font-light cursor-pointer' color='text-white' />
